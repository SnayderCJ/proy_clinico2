    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estado', models.CharField(choices=[('pendiente', 'Pendiente'), ('confirmada', 'Confirmada'), ('cancelada', 'Cancelada'), ('completada', 'Completada'), ('ausente', 'Paciente No Asistió')], max_length=10, verbose_name='Estado de la Cita')),
                ('observaciones', models.TextField(blank=True, null=True, verbose_name='Observaciones')),
